...
DELETE FROM TBLFACILITIES WHERE ID=@ID;
DELETE FROM TBLREQUESTTABLE WHERE ID=@ID;
DELETE FROM TBLREQUESTREPLY WHERE ID=@ID;
DELETE FROM TBLTRANSACTION WHERE ID=@ID;
DELETE FROM TBLBORROWED WHERE ID=@ID;
DELETE FROM TBLRETURNEDEQUIPMENTS WHERE ID=@ID;
DELETE FROM TBLEQUIPMENTRESERVATION WHERE ID=@ID;
