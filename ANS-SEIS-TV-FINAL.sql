...
AS
SELECT TBLEQUIPMENTDETAILS.EQUIPMENT_ID AS 'Equipment ID' , TBLEQUIPMENTDETAILS.EQUIPMENT_NAME AS 'Name', TBLEQUIPMENTDETAILS.EQUIPMENT_DESCRIPTION AS 'Description', (TBLEQUIPMENTDETAILS.EQUIPMENT_QUANTITY-TBLBORROWQUANTITY.QUANTITY) as 'Available Quantity' FROM TBLEQUIPMENTDETAILS
