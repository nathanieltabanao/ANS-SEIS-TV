...
as
SELECT TBLREQUESTTABLE.REQUESTID, TBLUSERDETAILS.FIRSTNAME+' '+TBLUSERDETAILS.MIDDLENAME +' '+ TBLUSERDETAILS.LASTNAME as 'Requested By', TBLREQUESTTABLE.REQUESTHEADER, TBLREQUESTTABLE.DATEREQUESTED FROM TBLREQUESTTABLE
...
INNER JOIN TBLUSERDETAILS ON TBLBORROWED.GENID=TBLUSERDETAILS.GENID
INNER JOIN TBLEQUIPMENTDETAILS ON TBLBORROWED.EQUIPMENT_ID=TBLEQUIPMENTDETAILS.EQUIPMENT_ID
WHERE TBLUSERDETAILS.GENID=1000001  AND TBLTRANSACTION.TransactionEvent ='Borrowed an Equipment' AND TBLBORROWED.IsReturned=0
