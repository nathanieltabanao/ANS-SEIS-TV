...
as
DELETE FROM TBLFACILITIES WHERE GENID =@GENID;
DELETE FROM TBLREQUESTTABLE WHERE GENID =@GENID;
DELETE FROM TBLREQUESTREPLY WHERE GENID =@GENID;
DELETE FROM TBLTRANSACTION WHERE GENID =@GENID;
DELETE FROM TBLBORROWED WHERE GENID =@GENID;
DELETE FROM TBLRETURNEDEQUIPMENTS WHERE GENID =@GENID;
DELETE FROM TBLEQUIPMENTRESERVATION WHERE GENID =@GENID;
DELETE FROM TBLUSERLOGINREPORT WHERE ID =@ID;
DELETE FROM TBLUSERACTIONREPORT WHERE ID =@ID;
DELETE FROM EQUIPMENT_DESIGNATION WHERE ID =@ID;
DELETE FROM TBLUSERDETAILS WHERE ID =@ID;
...
as
DELETE TBLEQUIPMENTSTATUS WHERE EQUIPMENT_ID=@EQUIPMENT_ID;
DELETE TBLRETURNEDEQUIPMENTS WHERE EQUIPMENT_ID=@EQUIPMENT_ID;
DELETE TBLEQUIPMENTRESERVATION  WHERE EQUIPMENT_ID=@EQUIPMENT_ID;
DELETE TBLPULLEDOUTEQUIPMENT WHERE EQUIPMENT_ID=@EQUIPMENT_ID;
DELETE TBLEQUIPMENTBARCODE WHERE EQUIPMENT_ID=@EQUIPMENT_ID;
DELETE TBLBORROWED WHERE EQUIPMENT_ID=@EQUIPMENT_ID;
DELETE TBLBORROWQUANTITY WHERE EQUIPMENT_ID=@EQUIPMENT_ID;
DELETE TBLEQUIPMENTDETAILS WHERE EQUIPMENT_ID=@EQUIPMENT_ID;
...
-- Equipment Report
CREATE PROC sp_EquipmentReports
as
SELECT TBLEQUIPMENTDETAILS.EQUIPMENT_ID, TBLEQUIPMENTDETAILS.EQUIPMENT_NAME, TBLEQUIPMENTTYPE.EQUIPMENT_TYPE_DESCRIPTION,TBLEQUIPMENTDETAILS.EQUIPMENT_QUANTITY FROM TBLEQUIPMENTDETAILS
INNER JOIN TBLEQUIPMENTTYPE ON TBLEQUIPMENTDETAILS.EQUIPMENT_TYPE_ID=TBLEQUIPMENTTYPE.EQUIPMENT_TYPE_ID
...
CREATE PROC sp_RequestReport
as
SELECT TBLREQUESTTABLE.REQUESTID, TBLUSERDETAILS.FIRSTNAME+' '+TBLUSERDETAILS.MIDDLENAME +' '+ TBLUSERDETAILS.LASTNAME as 'Requested By', TBLREQUESTTABLE.REQUESTHEADER, TBLREQUESTTABLE.DATEREQUESTED, REQUESTSTATUS.STATUSDESCRIPTION FROM TBLREQUESTTABLE
...
VALUES (@TransactionID,@WhoBorrowed,@EQUIPMENT_ID,@DATEBORROWED,@Quantity,@IsReturned)
...
as
UPDATE TBLBORROWED
SET  IsReturned=@IsReturned,   TBLBORROWED.Quantity=@Qty
WHERE TransactionID=@TransactionID AND EQUIPMENT_ID=@EquipmentID


CREATE PROC sp_BorrowedReport
as
SELECT DISTINCT TBLBORROWED.TransactionID, TBLUSERDETAILS.FIRSTNAME+' '+TBLUSERDETAILS.MIDDLENAME +' '+ TBLUSERDETAILS.LASTNAME as 'Borrowed By', TBLEQUIPMENTDETAILS.EQUIPMENT_NAME, TBLBORROWED.Quantity FROM TBLBORROWED
...
inner join TBLUSERDETAILS ON TBLBORROWED.GENID=TBLUSERDETAILS.GENID
WHERE TBLBORROWED.IsReturned=0

CREATE PROC sp_ReturnedReport
as
SELECT TBLBORROWED.TransactionID, TBLUSERDETAILS.FIRSTNAME+' '+TBLUSERDETAILS.MIDDLENAME +' '+ TBLUSERDETAILS.LASTNAME as 'Borrowed By', TBLEQUIPMENTDETAILS.EQUIPMENT_NAME, TBLBORROWED.Quantity, TBLRETURNEDEQUIPMENTS.DateReturned FROM TBLBORROWED
INNER JOIN TBLTRANSACTION ON TBLBORROWED.TransactionID=TBLTRANSACTION.TransactionID
inner join TBLEQUIPMENTDETAILS on TBLBORROWED.EQUIPMENT_ID=TBLEQUIPMENTDETAILS.EQUIPMENT_ID
inner join TBLUSERDETAILS ON TBLBORROWED.GENID=TBLUSERDETAILS.GENID
inner join TBLRETURNEDEQUIPMENTS on TBLBORROWED.EQUIPMENT_ID=TBLRETURNEDEQUIPMENTS.EQUIPMENT_ID
WHERE TBLBORROWED.IsReturned=1 AND TBLBORROWED.Quantity!=0

CREATE PROC sp_BorrowTeacherView
(
	@GENID INT
)
as
SELECT TBLBORROWED.TransactionID, TBLUSERDETAILS.FIRSTNAME+' '+TBLUSERDETAILS.MIDDLENAME +' '+ TBLUSERDETAILS.LASTNAME as 'Borrowed By', TBLEQUIPMENTDETAILS.EQUIPMENT_NAME, TBLBORROWED.Quantity FROM TBLBORROWED
INNER JOIN TBLTRANSACTION ON TBLBORROWED.TransactionID=TBLTRANSACTION.TransactionID
INNER JOIN TBLUSERDETAILS ON TBLBORROWED.GENID=TBLUSERDETAILS.GENID
INNER JOIN TBLEQUIPMENTDETAILS ON TBLBORROWED.EQUIPMENT_ID=TBLEQUIPMENTDETAILS.EQUIPMENT_ID
WHERE TBLUSERDETAILS.GENID=@GENID  AND TBLTRANSACTION.TransactionEvent ='Borrowed an Equipment' AND TBLBORROWED.IsReturned=0
...
CREATE PROC sp_EquipmentStatusReport
as
SELECT TBLEQUIPMENTDETAILS.EQUIPMENT_NAME, TBLEQUIPMENTSTATUS.GoodCondition, TBLEQUIPMENTSTATUS.BadCondition FROM TBLEQUIPMENTSTATUS
INNER JOIN TBLEQUIPMENTDETAILS ON TBLEQUIPMENTSTATUS.EQUIPMENT_ID=TBLEQUIPMENTDETAILS.EQUIPMENT_ID
...
as
SELECT TBLEQUIPMENTDETAILS.EQUIPMENT_ID as 'ID', TBLEQUIPMENTDETAILS.EQUIPMENT_NAME as 'Name', TBLBORROWED.Quantity, TBLBORROWED.IsReturned as 'Returned?'FROM TBLBORROWED
INNER JOIN TBLEQUIPMENTDETAILS ON TBLBORROWED.EQUIPMENT_ID=TBLEQUIPMENTDETAILS.EQUIPMENT_ID
INNER JOIN TBLTRANSACTION ON TBLBORROWED.TransactionID=TBLTRANSACTION.TransactionID
...
CREATE PROC sp_EquipmentReservationReport
(
	@StartDate datetime,
	@EndDate datetime
)
as
SELECT TBLEQUIPMENTRESERVATION.TransactionID, TBLUSERDETAILS.FIRSTNAME+' '+TBLUSERDETAILS.MIDDLENAME +' '+ TBLUSERDETAILS.LASTNAME as 'Reserved By', TBLEQUIPMENTDETAILS.EQUIPMENT_NAME, TBLEQUIPMENTRESERVATION.Quantity, TBLEQUIPMENTRESERVATION.DateReserved  FROM TBLEQUIPMENTRESERVATION
INNER JOIN TBLEQUIPMENTDETAILS ON TBLEQUIPMENTRESERVATION.EQUIPMENT_ID=TBLEQUIPMENTDETAILS.EQUIPMENT_ID
INNER JOIN TBLUSERDETAILS ON TBLEQUIPMENTRESERVATION.GENID=TBLUSERDETAILS.GENID
WHERE TBLEQUIPMENTRESERVATION.IsReturned=0 and TBLEQUIPMENTRESERVATION.DateReserved BETWEEN @StartDate AND @EndDate
...
CREATE PROC sp_DeploymentPullOut
(
	@RoomNo varchar(10),
	@EquipmentID int,
	@Quantity int
...
WHERE TBLFACILITIES.FacilityRoomNo=@RoomNo and TBLBORROWED.EQUIPMENT_ID=@EquipmentID



CREATE PROC sp_DeploymentReport
as
SELECT TBLTRANSACTION.TransactionID, TBLUSERDETAILS.FIRSTNAME+' '+TBLUSERDETAILS.MIDDLENAME +' '+ TBLUSERDETAILS.LASTNAME as 'Borrowed By', TBLEQUIPMENTDETAILS.EQUIPMENT_NAME, TBLBORROWED.Quantity,TBLTRANSACTION.TransactionDate, TBLFACILITIES.FacilityRoomNo  FROM TBLDEPLOYMENT
INNER JOIN TBLTRANSACTION ON TBLDEPLOYMENT.TransactionID=TBLTRANSACTION.TransactionID
INNER JOIN TBLFACILITIES ON TBLDEPLOYMENT.FacilitiyID=TBLFACILITIES.FacilityID
INNER JOIN TBLUSERDETAILS ON TBLFACILITIES.GENID=TBLUSERDETAILS.GENID
INNER JOIN TBLBORROWED ON TBLTRANSACTION.TransactionID=TBLBORROWED.TransactionID
INNER JOIN TBLEQUIPMENTDETAILS ON TBLBORROWED.EQUIPMENT_ID=TBLEQUIPMENTDETAILS.EQUIPMENT_ID



CREATE PROC sp_DeploymentViewTeacher
(
	@GENID int
)
as
...
-- TABLES FOR PULL OUT
select * from TBLPULLEDOUTEQUIPMENT
...
as
SELECT DISTINCT TBLEQUIPMENTDETAILS.EQUIPMENT_ID as 'ID', TBLEQUIPMENTDETAILS.EQUIPMENT_NAME as 'Name', TBLBORROWED.Quantity, TBLBORROWED.IsReturned as 'Returned?'FROM TBLBORROWED
INNER JOIN TBLEQUIPMENTDETAILS ON TBLBORROWED.EQUIPMENT_ID=TBLEQUIPMENTDETAILS.EQUIPMENT_ID
INNER JOIN TBLTRANSACTION ON TBLBORROWED.TransactionID=TBLTRANSACTION.TransactionID
INNER JOIN TBLDEPLOYMENT ON TBLBORROWED.TransactionID=TBLDEPLOYMENT.TransactionID
INNER JOIN TBLFACILITIES ON TBLDEPLOYMENT.FacilitiyID=TBLFACILITIES.FacilityID
...
CREATE PROC sp_PulledEquipmentsView
as
SELECT TBLEQUIPMENTDETAILS.EQUIPMENT_NAME,TBLEQUIPMENTDETAILS.EQUIPMENT_DESCRIPTION, TBLPULLEDOUTEQUIPMENT.QUANTITY FROM TBLPULLEDOUTEQUIPMENT
INNER JOIN TBLEQUIPMENTDETAILS ON TBLPULLEDOUTEQUIPMENT.EQUIPMENT_ID=TBLEQUIPMENTDETAILS.EQUIPMENT_ID
WHERE TBLPULLEDOUTEQUIPMENT.QUANTITY >= 0
...
values	('AD-1000000','nate','1234','Nathaniel Angelico','Borres','Tabanao','09395686461','Where Do you live?','Cave','110','1'),
		('TR-1000001','jamie','1234','Jamie Hanna','Short','Dionson','09222729916','test','test','111','1'),
...
INSERT INTO TBLFACILITIES
VALUES	('Computer Laboratory 1', 1000001, 'Computer Laboratory', '1CL1'),
		('Computer Laboratory 2', 1000002, 'Computer Laboratory', '1CL2'),
		('Computer Laboratory 3', 1000003, 'Computer Laboratory', '1CL3'),
		('Computer Laboratory 4', 1000004, 'Computer Laboratory', '1CL4')
